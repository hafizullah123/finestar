...
<html lang="en">
  ...
  <body class="m-0 p-0 bg-white">
    ...
    <section class="max-w-5xl mx-auto py-0 px-0 rounded-lg">
      <!-- Title -->
      <h1
        class="text-3xl font-bold mb-2 inline-block pb-0"
      >
        Activities
      </h1>
      ...
      <div class="grid md:grid-cols-2 gap-4 my-4">
        <div>
          <h3 class="text-xl font-semibold mb-4">Sourcing & Procurement</h3>
          ...
          <p class="text-gray-600">
            We source premium-quality nuts and dried fruits directly from
            trusted farms and growers around the world.
          </p>
        </div>
        <div>
          <img
            src="dryfruitspng/sourcing_and_procurement.png"
            alt="Sourcing"
      ...
      <!-- Section 2: Processing & Packaging -->
      <div class="grid md:grid-cols-2 gap-4 my-4">
        <div class="order-2 md:order-1">
          <img
            src="dryfruitspng/processing_and_packaging.png"
            alt="Processing"
            class="rounded-lg shadow-md w-full object-cover h-64"
          />
        </div>
        <div class="order-1 md:order-2">
          <h3 class="text-xl font-semibold mb-4">Processing & Packaging</h3>
          <p class="text-gray-600 mb-4">
            Lorem ipsum is simply dummy text of the printing and typesetting
            industry. Lorem Ipsum has been the industry's standard dummy text
          ...
          <p class="text-gray-600">
            Our state-of-the-art facility ensures hygiene, processing, grading,
            and packaging that preserves freshness and flavor.
          </p>
        </div>
      </div>

      <!-- Section 3: Wholesale & Retail Distribution -->
      <div class="grid md:grid-cols-2 gap-4 my-4">
        <div>
          ...
          <p class="text-gray-600">
            We supply wholesalers, retailers, and customers directly with
            premium-quality products worldwide.
          </p>
        </div>
        <div>
          <img
      ...
      <!-- Section 4: Export & Import Services -->
      <div class="grid md:grid-cols-2 gap-4">
        <div class="order-2 md:order-1">
          <img
            src="dryfruitspng/export_and_mport_services.png"
            alt="Export Import"
            class="rounded-lg shadow-md w-full object-cover h-64"
          />
        </div>
        <div class="order-1 md:order-2">
          <h3 class="text-xl font-semibold mb-4">Export & Import Services</h3>
          <p class="text-gray-600 mb-4">
            Lorem ipsum is simply dummy text of the printing and typesetting
            industry. Lorem Ipsum has been the industry's standard dummy text
            ever since the 1500s.
          ...
          <p class="text-gray-600">
            Our export-import division ensures delivery of high-quality dry
            fruits to multiple countries efficiently.
          </p>
        </div>
      </div>
    </section>
...
>
  ...
  <div class="container mx-auto mt-20 px-6 text-center md:text-left">
    <!-- 🌟 Main Title -->
    <h1 class="text-2xl font-semibold text-white mb-8 text-center md:text-left">
      fine star
    </h1>
    ...
    <style>
      ...
      .footer-bg {
        background-image: url("dryfruitspng/footer_image.png"); /* your full footer bg image */
        background-size: cover;
        background-position: center;
        background-repeat: no-repeat;
        background-color: rgba(165, 91, 78, 0.95); /* keep overlay color */
